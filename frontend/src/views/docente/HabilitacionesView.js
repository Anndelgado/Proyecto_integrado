// ======================================================
// HabilitacionesView.js
// Barranquilla Convive
// ======================================================
//
// El docente habilita a un estudiante de su institución para
// presentar una prueba puntual del módulo de Tamizaje Psicológico.
// Cada habilitación es de un solo uso: se desactiva automáticamente
// cuando el estudiante envía sus respuestas (ver TamizajeService.js).
//
// Esta vista, con el detalle de resultados por estudiante, es
// exclusiva del docente. El psicólogo/a solo accede al reporte
// consolidado (ver views/psicologo/ReportesView.js), no a esta
// pantalla con el detalle estudiante por estudiante.
//
// Nota: el backend conserva el nombre de columna "psicologoId" en
// tamizajeHabilitaciones por compatibilidad de esquema; aquí guarda
// el id de quien habilita la prueba (ahora el docente).
//
// ======================================================
...
export async function HabilitacionesView() {
    ...
    //==================================================
    // Formulario para habilitar una prueba
    //==================================================
