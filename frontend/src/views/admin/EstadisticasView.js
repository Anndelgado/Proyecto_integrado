...
import { normalizeRole } from "../../components/layout/navigation.js";
export async function EstadisticasView() {
    ...
    chartsGrid.append(
        ...
        ChartCard({
            ...
            subtitle: `Estudiantes: ${porRol.estudiante ?? 0} · Docentes: ${porRol.docente ?? 0} · Psicólogos: ${porRol.psicologo ?? 0} · Admins: ${porRol.admin ?? 0}`
