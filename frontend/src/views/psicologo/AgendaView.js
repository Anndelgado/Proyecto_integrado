...
// Datos de agenda
//
// Las citas se persisten en la colección "citas" de database/db.json
// a través de CitaService.js, igual que el resto de módulos del
// proyecto (alertas, seguimientos, etc.). El listado de estudiantes
// con casos activos también viene de la API, para que las citas se
// puedan asociar a un caso real.
//======================================================
...
export async function AgendaView() {
    ...
    // Estado local de la agenda, sincronizado con la API a través de
    // CitaService.js (ver cargarCitas/renderLista más abajo).
