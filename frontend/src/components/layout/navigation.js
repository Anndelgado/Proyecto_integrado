...
/**
 * Etiqueta legible para mostrar el rol de un usuario en la UI
 * (Topbar, tablas de usuarios, etc.). Normaliza primero el rol para
 * que "orientador" (nombre usado en la base de datos) siempre se
 * muestre como "Psicólogo".
 */
