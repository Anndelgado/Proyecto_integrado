...
import { findUserByEmail, createUser } from "../api.js";
...
function wireRegisterForm(root) {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    if (!nombre || !codigoInstitucion || !correo || !password) {
    ...
    try {
      ...
      showError(
        "No pudimos conectar con el servidor. Verifica que json-server esté ejecutándose."
      );
